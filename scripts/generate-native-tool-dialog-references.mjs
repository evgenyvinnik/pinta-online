...
const refs = [
  {
    ...
    subtitle: 'Rows are icon + label + trailing selected checkmark. The closed control shows only the icon unless noted.',
    html: `<div class="grid">
  ...
  },
  {
    ...
    subtitle: 'Exact toolbar order is significant. Rounded Rectangle places Radius before Fill Style. Arrow numeric controls are inserted only when Arrow 1 or 2 is enabled.',
  ...
  },
  {
    ...
    subtitle: 'The live native Font chooser is Gtk.FontDialogButton (Family level, modal). The tool toolbar is horizontally scrollable.',
  ...
  },
  {
    ...
    subtitle: 'These are child dialogs of the native Add-in Manager. Web add-ins are bundled, so the web manager intentionally has no file/network installation workflow.',
    html: `<div class="grid two">
  ...
  },
  {
    ...
    subtitle: 'All configurable Ars Kali effects use Pinta SimpleEffectDialog: modal, fixed 400 px request, non-resizable, 12 px vertical spacing, 6 px margins, Cancel/OK.',
    html: `<div class="grid two">
  ...
  },
  {
    ...
    subtitle: 'Colored Grayscale and Block Brush have no configuration dialog; their no-popup status is explicitly recorded in the audit.',
    html: `<div class="grid two">
  ...
  },
  {
    ...
    subtitle: 'Native tool options live in a horizontally scrolling Gtk.ScrolledWindow: automatic horizontal policy, no vertical scrollbar, overlay scrolling, bottom-right placement.',
