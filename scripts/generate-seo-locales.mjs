...
const copy = {
  fr: {
    ...
    stats: ['outils de dessin et d’édition', 'modes de fusion natifs', 'ajustements et effets', 'formats d’image ouverts'],
    features: {
      ...
      cards: [
        ['✦', 'Dessiner et retoucher', 'Utilisez pinceau, crayon, gomme, remplissage, dégradés, tampon de clonage, recoloration et pipette avec largeur et tolérance réglables.'],
        ['◫', 'Sélectionner précisément', 'Créez des sélections rectangulaires, elliptiques, au lasso, polygonales ou par baguette magique, puis combinez-les, déplacez-les ou recadrez.'],
        ['▱', 'Travailler en calques', 'Créez, dupliquez, fusionnez, réordonnez, masquez et transformez les calques avec opacité, miniatures et 16 modes de fusion.'],
        ['T', 'Texte et formes', 'Modifiez du texte multiligne sur le canevas et dessinez lignes, courbes, rectangles, ellipses et formes libres avec des poignées actives.'],
        ['ƒ', 'Ajuster et transformer', 'Réglez courbes, niveaux, teinte et contraste, puis explorez flous, bruit, distorsions, traitements artistiques et outils photo.'],
        ['↺', 'Annuler sans crainte', 'Chaque document garde un historique complet tandis que ses calques, sa sélection, son zoom, son nom et son état restent indépendants.'],
      ],
    },
    screenshots: {
    ...
    formats: {
      ...
      open: 'Ouvrir', save: 'Enregistrer', theme: 'Les thèmes sombre et clair mémorisent votre préférence.',
    },
    local: {
      ...
      points: [['Sans compte', 'Ouvrez l’éditeur et commencez immédiatement.'], ['Sans étape d’envoi', 'L’édition et les effets s’exécutent dans le navigateur.'], ['Restauration complète', 'Retrouvez documents, calques et historique.'], ['Prêt hors ligne', 'L’interface et les illustrations sont mises en cache.']],
    },
    faq: {
      eyebrow: 'Bon à savoir', title: 'Questions fréquentes.',
      items: [
        ['Pinta Online est-il gratuit ?', 'Oui. L’éditeur de paint.rip est gratuit et ne nécessite aucun compte.'],
        ['Mes images sont-elles envoyées à un serveur ?', 'Non. Le décodage, la composition, les transformations et l’export se font dans votre navigateur. La restauration est conservée localement sur cet appareil.'],
        ['Peut-il conserver les calques ?', 'Oui. L’import et l’export OpenRaster conservent noms, visibilité, opacité, modes de fusion, ordre et pixels des calques.'],
        ['Utilise-t-il les raccourcis Pinta ?', 'Oui. Ctrl/Commande+N, O, S, W, R et les touches d’outils d’origine sont capturés par l’éditeur.'],
        ['Puis-je l’installer ?', 'Oui. Un navigateur compatible peut installer Pinta Online comme application web progressive et lancer son interface hors ligne.'],
      ],
    },
  ...
  de: {
    ...
    hero: {
      ...
      start: 'Jetzt malen', see: 'Oberfläche ansehen',
      trust: ['Kostenlos', 'Lokale Bearbeitung', 'Installierbar und offline'],
      caption: 'Der vollständige Arbeitsbereich auf paint.rip',
    },
    stats: ['Zeichen- und Bearbeitungswerkzeuge', 'native Mischmodi', 'Anpassungen und Effekte', 'geöffnete Bildformate'],
    features: {
      eyebrow: 'Echte Bearbeitungswerkzeuge', title: 'Alles, was du von einem Bildeditor erwartest.',
      ...
      cards: [
        ['✦', 'Zeichnen und retuschieren', 'Nutze Pinsel, Stift, Radierer, Füllwerkzeug, Verläufe, Klonstempel, Umfärben und Farbpipette mit einstellbarer Breite und Toleranz.'],
        ['◫', 'Gezielt auswählen', 'Erstelle Rechteck-, Ellipsen-, Lasso-, Polygon- und Zauberstab-Auswahlen und kombiniere, verschiebe, fülle oder beschneide sie.'],
        ['▱', 'Ideen auf Ebenen', 'Erstelle, dupliziere, verbinde, sortiere, verstecke und transformiere Ebenen mit Deckkraft, Vorschaubildern und 16 Mischmodi.'],
        ['T', 'Text und Formen', 'Bearbeite mehrzeiligen Text auf der Leinwand und zeichne Linien, Kurven, Rechtecke, Ellipsen und freie Formen mit interaktiven Griffen.'],
        ['ƒ', 'Anpassen und transformieren', 'Arbeite mit Kurven, Tonwerten, Farbton und Kontrast sowie Unschärfe, Rauschen, Verzerrungen, Kunst- und Fotowerkzeugen.'],
        ['↺', 'Sicher rückgängig', 'Jedes Dokument behält seinen gesamten Verlauf; Ebenen, Auswahl, Zoom, Dateiname und Änderungsstatus bleiben unabhängig.'],
      ],
    },
    screenshots: {
      eyebrow: 'Die echte Oberfläche', title: 'Ein Arbeitsbereich, der nicht im Weg steht.',
    ...
    formats: { eyebrow: 'Offene Formate, lokale Dateien', title: 'Deine Bilder bleiben nützlich – und bleiben deine.', lead: 'Pinta Online verarbeitet Bilder im Browser. Öffne mehrere Dateien in unabhängigen Tabs und exportiere sie im passenden Format für den nächsten Schritt.', open: 'Öffnen', save: 'Speichern', theme: 'Dunkles und helles Design merken sich deine Einstellung.' },
    local: {
      eyebrow: 'Lokale Progressive Web App', title: ['Öffnen wie eine Website.', 'Nutzen wie eine App.'],
      ...
      points: [['Kein Konto nötig', 'Editor öffnen und sofort anfangen.'], ['Kein Bild-Upload', 'Bearbeitung und Effekte laufen im Browser.'], ['Vollständige Wiederherstellung', 'Dokumente, Ebenen und Verlauf bleiben erhalten.'], ['Offline bereit', 'App-Oberfläche und Grafiken werden vorgeladen.']],
    },
    faq: {
      eyebrow: 'Gut zu wissen', title: 'Fragen und Antworten.',
  ...
  ar: {
    ...
    hero: {
      ...
      start: 'ابدأ الرسم الآن', see: 'شاهد الواجهة',
    ...
    features: {
      eyebrow: 'أدوات تحرير حقيقية', title: 'كل ما تتوقعه من محرر صور.',
      lead: 'يجمع بِنْتا أونلاين أهم مسارات الرسم والصور والطبقات والتحديد والمؤثرات في تطبيق ويب سريع الاستجابة.',
      cards: [
        ['✦', 'ارسم ونقّح', 'استخدم الفرشاة والقلم والممحاة والتعبئة والتدرجات وختم الاستنساخ وإعادة التلوين والقطّارة مع عرض وتفاوت قابلين للضبط.'],
        ['◫', 'حدد بدقة', 'أنشئ تحديدات مستطيلة وبيضاوية وحرة ومضلعة وبالعصا السحرية، ثم ادمجها أو حرّكها أو املأها أو اقتصّها.'],
        ['▱', 'نظّم أفكارك في طبقات', 'أنشئ الطبقات وكررها وادمجها ورتبها وأخفها وحوّلها مع التحكم بالعتامة والصور المصغرة و16 وضع مزج.'],
        ['T', 'اكتب وارسم الأشكال', 'حرّر نصًا متعدد الأسطر على اللوحة وارسم الخطوط والمنحنيات والمستطيلات والأشكال البيضاوية والحرة بمقابض مباشرة.'],
        ['ƒ', 'عدّل وحوّل', 'استخدم المنحنيات والمستويات واللون والتباين، واستكشف التمويه والضجيج والتشويه والمعالجات الفنية وأدوات الصور.'],
        ['↺', 'تراجع بثقة', 'يحتفظ كل مستند بسجله الكامل، وتبقى طبقاته وتحديده وتقريبه واسمه وحالة تعديلاته مستقلة.'],
      ],
    },
    screenshots: {
      eyebrow: 'الواجهة الفعلية', title: 'مساحة عمل لا تعترض طريقك.',
    ...
    formats: { eyebrow: 'صيغ مفتوحة وملفات محلية', title: 'تبقى صورك مفيدة — وتبقى ملكك.', lead: 'يعالج بِنْتا أونلاين الصور داخل متصفحك. افتح عدة ملفات في ألسنة مستقلة وصدّر كلًا منها بالصيغة المناسبة لخطوتك التالية.', open: 'فتح', save: 'حفظ', theme: 'يتذكر المظهران الداكن والفاتح تفضيلك.' },
    local: {
      eyebrow: 'تطبيق ويب تقدمي محلي', title: ['افتحه كموقع.', 'واستخدمه كتطبيق.'],
      ...
      points: [['لا يحتاج إلى حساب', 'افتح المحرر وابدأ فورًا.'], ['لا توجد خطوة رفع', 'التحرير والمؤثرات يعملان في المتصفح.'], ['استعادة كاملة', 'ارجع إلى المستندات والطبقات والسجل.'], ['جاهز دون اتصال', 'تُخزّن الواجهة والرسومات مسبقًا.']],
    },
    faq: {
      eyebrow: 'من المفيد أن تعرف', title: 'أسئلة وإجابات.',
  ...
  he: {
    ...
    hero: {
      ...
      start: 'להתחיל לצייר', see: 'לראות את הממשק',
    ...
    features: {
      eyebrow: 'כלי עריכה אמיתיים', title: 'כל מה שמצפים מעורך תמונות.',
      lead: 'Pinta Online מרכז את תהליכי הציור, התמונה, השכבות, הבחירה והאפקטים החשובים ביישום רשת מגיב אחד.',
      cards: [
        ['✦', 'ציור וריטוש', 'השתמשו במכחול, עיפרון, מחק, מילוי, מעברי צבע, חותמת שיבוט, צביעה מחדש ודוגם צבע עם רוחב וסבילות מתכווננים.'],
        ['◫', 'בחירה מדויקת', 'צרו בחירות מלבניות, אליפטיות, חופשיות, מצולעות ובמטה קסם, ואז שלבו, הזיזו, מלאו או חתכו אותן.'],
        ['▱', 'רעיונות בשכבות', 'צרו, שכפלו, מזגו, סדרו, הסתירו ושנו שכבות עם אטימות, תמונות ממוזערות ו־16 מצבי שילוב.'],
        ['T', 'טקסט וצורות', 'ערכו טקסט מרובה שורות על הבד וציירו קווים, עקומות, מלבנים, אליפסות וצורות חופשיות עם ידיות פעילות.'],
        ['ƒ', 'התאמה ושינוי', 'עבדו עם עקומות, רמות, גוון וניגודיות, וטשטוש, רעש, עיוותים, טיפולים אמנותיים וכלי צילום.'],
        ['↺', 'ביטול בלי חשש', 'כל מסמך שומר היסטוריה מלאה, והשכבות, הבחירה, הזום, שם הקובץ ומצב השינויים נשארים עצמאיים.'],
      ],
    },
    screenshots: {
      eyebrow: 'הממשק האמיתי', title: 'סביבת עבודה שלא מפריעה.',
    ...
    formats: { eyebrow: 'פורמטים פתוחים, קבצים מקומיים', title: 'התמונות נשארות שימושיות — ונשארות שלכם.', lead: 'Pinta Online מעבד תמונות בדפדפן. פתחו כמה קבצים בכרטיסיות עצמאיות וייצאו לפורמט המתאים לשלב הבא.', open: 'פתיחה', save: 'שמירה', theme: 'ערכת הנושא הכהה והבהירה זוכרות את ההעדפה.' },
    local: {
      eyebrow: 'יישום רשת מתקדם ומקומי', title: ['פותחים כמו אתר.', 'משתמשים כמו אפליקציה.'],
      ...
      points: [['בלי חשבון', 'פותחים את העורך ומתחילים מיד.'], ['בלי העלאת תמונות', 'העריכה והאפקטים רצים בדפדפן.'], ['שחזור מלא', 'חוזרים למסמכים, לשכבות ולהיסטוריה.'], ['מוכן לעבודה לא מקוונת', 'הממשק והאיורים נשמרים מראש.']],
    },
    faq: {
      eyebrow: 'כדאי לדעת', title: 'שאלות ותשובות.',
...
function openGraphLocales(locale) {
  return [
    ...
    ...allCodes.filter((code) => code !== locale).map((code) => `    <meta property="og:locale:alternate" content="${localeMeta[code].ogLocale}" />`),
  ].join('\n');
}
    ...
    '@graph': [
      {
        ...
        name: text.editorOgTitle, description: text.editorDescription, inLanguage: locale,
        isPartOf: { '@id': `${origin}/#website` }, mainEntity: { '@id': `${origin}/#software` },
      },
      {
        '@type': 'SoftwareApplication', '@id': `${origin}/#software`, name: 'Pinta Online', alternateName: 'Paint.rip',
        url: canonical, applicationCategory: 'DesignApplication',
        operatingSystem: 'Any operating system with a modern web browser',
        browserRequirements: 'Requires JavaScript, HTML5 Canvas, and a modern browser',
        softwareVersion: '__PINTA_ONLINE_VERSION__', isAccessibleForFree: true, inLanguage: locale,
        image: `${origin}/about/assets/pinta-online-og.jpg`, screenshot: `${origin}/about/assets/editor-dark.webp`,
        description: text.editorDescription,
        offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' }, featureList: text.featureList,
      },
    ],
  };
  return `<!doctype html>
...
function aboutPage(locale, text) {
  ...
  const details = [
    ['curves.webp', 520, 576], ['clouds.webp', 520, 414], ['oil-painting.webp', 520, 280], ['keyboard-shortcuts.webp', 760, 720],
  ];
  const graph = {
    '@context': 'https://schema.org',
    '@graph': [
      {
        '@type': 'WebPage', '@id': `${canonical}#page`, url: canonical, name: text.aboutTitle.replace(' | Paint.rip', ''),
        description: text.aboutDescription, inLanguage: locale, isPartOf: { '@id': `${origin}/#website` },
        mainEntity: { '@id': `${origin}/#software` }, primaryImageOfPage: { '@id': `${canonical}#hero-image` },
      },
      { '@type': 'ImageObject', '@id': `${canonical}#hero-image`, url: `${origin}/about/assets/pinta-online-og.jpg`, width: 1200, height: 630, caption: text.editorImageAlt },
      ...
      {
        '@type': 'SoftwareApplication', '@id': `${origin}/#software`, name: 'Pinta Online', url: editorUrl,
        applicationCategory: 'DesignApplication', operatingSystem: 'Any operating system with a modern web browser',
        browserRequirements: 'Requires JavaScript, HTML5 Canvas, and a modern browser', softwareVersion: '__PINTA_ONLINE_VERSION__',
        isAccessibleForFree: true, inLanguage: locale, image: `${origin}/about/assets/pinta-online-og.jpg`,
        screenshot: [`${origin}/about/assets/editor-dark.webp`, `${origin}/about/assets/text-editor.webp`, `${origin}/about/assets/effects-library.webp`],
        description: text.aboutDescription, offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' }, featureList: text.featureList,
      },
    ],
  };
  return `<!doctype html>
