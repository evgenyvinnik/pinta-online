...
import type {
  AlphaBlendingMode, ColorPickerAfterSelect, ColorPickerSampleType, EraserType, FloodMode,
  GradientColorMode, GradientType, LassoMode, PaintBrushType, ShapeDashStyle,
  ShapeFillStyle, TextAlignment, TextStyle, TextVariant, ToolId,
} from './types';
