...
export function usePaintEditor() {
  ...
  const {
    ...
    moveLayer, flipLayer, clearLayerTransformPreview, previewLayerProperties,
    previewRotateZoomLayer, rotateZoomLayer, flattenImage, toggleLayer, renameLayer,
  ...
  const {
    ...
    eraseCurrentSelection, cutSelection, paste, pasteIntoNewLayer, pasteIntoNewImage,
    fillSelection, invertSelection, offsetSelection,
    ...
    setDimensions, setHasClipboard, setClipboardSize, setTool, updateSelection,
    updateFloatingPixels,
  });
