...
export const EFFECT_DEFINITIONS: EffectDefinition[] = [
  ...
  },
  {
    ...
    icon: 'adjustments-sepia-symbolic.svg', description: 'Apply a warm monochrome tone.',
  ...
  },
  {
    ...
    parameters: [
      ...
      { key: 'pointArrangement', label: 'Point Arrangement', min: 0, max: 2, step: 1, defaultValue: 0, kind: 'select', options: POINT_ARRANGEMENT_OPTIONS },
      { key: 'pointSeed', label: 'Random Point Locations', min: 0, max: 2147483646, step: 1, defaultValue: 0, visibleWhen: { key: 'pointArrangement', equals: 0 } },
      { key: 'showPoints', label: 'Show Points', min: 0, max: 1, step: 1, defaultValue: 0, kind: 'boolean' },
  ...
  },
  {
    ...
    parameters: [
      { key: 'direction', label: 'Drag direction', min: 0, max: 1, step: 1, defaultValue: 0, kind: 'select', options: [{ value: 0, label: 'X' }, { value: 1, label: 'Y' }] },
  ...
  },
  {
    ...
    parameters: [
      ...
      { key: 'sampleMode', label: 'Sample mode', min: 0, max: 1, step: 1, defaultValue: 0, kind: 'select', options: [{ value: 0, label: 'Average' }, { value: 1, label: 'Center' }] },
      { key: 'offsetX', label: 'Offset X', min: -1, max: 1, step: 0.05, defaultValue: 0 },
      { key: 'offsetY', label: 'Offset Y', min: -1, max: 1, step: 0.05, defaultValue: 0 },
