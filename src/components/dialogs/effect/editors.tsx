...
import { buildCurveLookup, curvePointsFromParameters, curveSvgPath, setCurvePoints, type CurveChannel, type CurvePoint } from '../../../effects/curves';
import { PintaIcon } from '../../primitives';
import { DialogResetButton, DialogStepper } from '../../dialogControls';
...
export const LEVEL_CONTROLS: Array<{ key: LevelControlKey; label: string; min: number; max: number; step: number }> = [
