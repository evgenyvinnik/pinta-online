...
export function InformationDialog({ title, message, onClose }: { title: string; message: string; onClose: () => void }) {
  return (
...
export function ErrorReportDialog({ error, onClose, onReportBug }: {
...
export function EffectProgressDialog({ effectName, progress, onCancel }: { effectName: string; progress: number; onCancel: () => void }) {
  return (
...
export function PrintDialog({ preview, onCancel, onPrint, onSettingsChange }: { preview: PrintPreview; onCancel: () => void; onPrint: () => void; onSettingsChange: (settings: PrintSettings) => void }) {
...
export function OffsetSelectionDialog({ onCancel, onSubmit }: { onCancel: () => void; onSubmit: (offset: number) => void }) {
...
export function ScreenshotDialog({ busy, error, onCancel, onCapture }: { busy: boolean; error: string; onCancel: () => void; onCapture: (delay: number) => void }) {
...
export function CanvasGridDialog({ settings, onCancel, onSubmit }: { settings: CanvasGridSettings; onCancel: () => void; onSubmit: (settings: CanvasGridSettings) => void }) {
